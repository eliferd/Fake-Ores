...
public class EntityDiamondOre extends EntityOres {
	...
	public EntityDiamondOre(EntityType<?> type, World world) {
		super(type, world);
	...
	public EntityDiamondOre(World world) {
		this(FakeOresEvents.FAKE_DIAMOND, world);
	}
	...
	public void onDeath(DamageSource cause) {
		super.onDeath(cause);
		if (!world.isRemote) {
			this.entityDropItem(new ItemStack(Items.DIAMOND, rand.nextInt(2)+1));
