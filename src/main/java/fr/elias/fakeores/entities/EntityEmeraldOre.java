...
public class EntityEmeraldOre extends EntityOres {
	...
	public EntityEmeraldOre(EntityType<?> type, World world) {
		super(type, world);
	...
	public EntityEmeraldOre(World world) {
		this(FakeOresEvents.FAKE_EMERALD, world);
	}
	...
	public void onDeath(DamageSource cause) {
		super.onDeath(cause);
		if (!world.isRemote) {
			this.entityDropItem(new ItemStack(Items.EMERALD, rand.nextInt(2)+1));
