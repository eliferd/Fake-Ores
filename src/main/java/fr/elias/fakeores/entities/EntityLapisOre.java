...
public class EntityLapisOre extends EntityOres {
	...
	public EntityLapisOre(EntityType<?> type, World world) {
		super(type, world);
	...
	public EntityLapisOre(World world) {
		this(FakeOresEvents.FAKE_LAPIS, world);
	}
	...
	public void onDeath(DamageSource cause) {
		super.onDeath(cause);
		if (!world.isRemote) {
			this.entityDropItem(new ItemStack(Items.LAPIS_LAZULI, 4 + rand.nextInt(5)));
