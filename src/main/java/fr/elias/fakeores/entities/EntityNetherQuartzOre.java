...
public class EntityNetherQuartzOre extends EntityOres {
	...
	public EntityNetherQuartzOre(EntityType<?> type, World world) {
		super(type, world);
	...
	public EntityNetherQuartzOre(World world) {
		this(FakeOresEvents.FAKE_QUARTZ, world);
	}
	...
	public void onDeath(DamageSource cause) {
		super.onDeath(cause);
		if (!world.isRemote) {
				this.entityDropItem(new ItemStack(Items.QUARTZ, rand.nextInt(2)+1));
